...
ActiveRecord::Schema[8.0].define(version: 2025_09_16_072032) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  create_table "fcm_identities", force: :cascade do |t|
    ...
    t.index ["active", "user_id", "device_id"], name: "index_fcm_identities_on_active_and_user_id_and_device_id"
  end
