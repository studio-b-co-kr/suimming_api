...
Devise.setup do |config|
  ...
  # config.secret_key = '3162a9afe4036955d3271bc6ba88cf196286cd908db2d698b90bbe9c4d809324c36b869774f287d87670162b030ac6744d737b1af4a456f4cb7b02b24d43fce6'
  ...
  # config.pepper = '6f8a0f96bba7dd58248cf57636c82bd81571efc58448a35cd07d47fc64b4825b95c4b97b8708ec746b7a431245231f240e0ea11294692fa13f56aa50649cd348'
  ...
  config.jwt do |jwt|
    ...
    jwt.dispatch_requests = [['POST', %r{^/api/v1/users/sign_in([.]json)?$}],
                             ['POST', %r{^/api/v1/users/sign_up([.]json)?$}]]
